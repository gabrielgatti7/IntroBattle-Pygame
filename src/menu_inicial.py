...
class Menu:
    """
    Classe responsável por representar o menu inicial do jogo.
    Atributos:
    - personagens (list): Lista de nomes dos personagens disponíveis.
    - fonte (pygame.font.Font): Fonte utilizada para renderizar o texto.
    - opcoes (list): Lista que contém listas com a imagem do personagem, imagem do menu correspondente,
                    o nome renderizado, e um inteiro indicando se está selecionado para cada opção.
    - opcoes_saltadas (list): Lista de listas com a imagem do personagem, imagem do menu correspondente,
                    e o nome renderizado com uma escala aumentada para cada opção.
    - personagens_selecionados (list): Lista de personagens selecionados pelo jogador.
    - som_selecao (str): Caminho do arquivo de som de seleção.
    Métodos:
    - __init__(): Construtor da classe, inicializa os atributos.
    - desenhar_menu(janela): Desenha o menu na janela do jogo.
    - seleciona_personagem(posicao): Seleciona ou deseleciona um personagem do menu.
    - selecionou_todos(): Verifica se 3 personagens foram selecionados.
    """
    ...
    def __init__(self):
        ...
        for nome in self.personagens:
            personagem_img = pygame.image.load(f"media/imagens/{nome}.png".lower())
        ...
        self.som_selecao = 'media/sounds/menu-selection-102220.mp3'
    ...
    def desenhar_menu(self, janela):
        ...
        fonte_titulo = pygame.font.Font('media/font/EightBitDragon-anqx.ttf', 40)
    ...
    def seleciona_personagem(self, posicao):
        som_efeito = pygame.mixer.Sound(self.som_selecao)
        som_efeito.play()
